...
//  PeriodicTask = task;          // user function
  ...
  TIMER3_CFG_R = 0x00000001;    // 2) configure for 32-bit mode
//  TIMER3_TAMR_R = 0x00000000;   // 3) configure for periodic mode, default down-count settings
//  TIMER3_TAILR_R = 0;    				// 4) reload value
