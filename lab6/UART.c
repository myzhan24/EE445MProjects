...
#define UARTPRIORITY						0x00008000	// priority 4										
...
//semaphores for the fifos
Sema4Type RxDataAvailable;		// init: 0
Sema4Type TxRoomLeft;					// init: FIFOSIZE
...
//	int sr = StartCritical();
  ...
  //UART0_FBRD_R = 8;                     // FBRD = int(0.1267 * 64 + 0.5) = 8
	UART0_IBRD_R = 43;										// 80,000,000 /(16*115,200)
	UART0_FBRD_R = 26;										// .402777777777777777777777777778 * 64 + 0.5= 26
...
//  NVIC_PRI1_R = (NVIC_PRI1_R&0xFFFF00FF)|0x00004000; // bits 13-15
	NVIC_PRI1_R = (NVIC_PRI1_R&0xFFFF0FFF)|UARTPRIORITY; // bits 13-15
...
//OUT
//TXRoomLeft starts out at FIFOSIZE
