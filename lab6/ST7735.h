...
// below this line is content by Rob and Matt
...
void ST7735_PlotArrayVF(long *mag, int len, int min, int max);
void ST7735_PlotArrayVFDub(double *mag, int len, int min, int max);
