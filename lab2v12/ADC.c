...
#define ADCPRIORITY							0x00008000	//priority 4
...
//	NVIC_PRI4_R = (NVIC_PRI4_R&0xFFFF00FF)|0x0000E000; //priority 7
	...
	NVIC_PRI4_R = (NVIC_PRI4_R&0xFFFF00FF)|ADCPRIORITY; //priority 1
...
void ADC_Collect(uint8_t channelNum, uint32_t FS, void (*task)(unsigned long)){
	...
	*/
	...
	//NVIC_PRI4_R = (NVIC_PRI4_R&0xFFFFFF00)|0x00000020; //priority 1
		NVIC_PRI4_R = (NVIC_PRI4_R&0xFFFFFF00)|ADCPRIORITY; //priority 1
